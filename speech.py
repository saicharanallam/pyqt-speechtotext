...
def listen_print_loop(responses):
    ...
    for response in responses:
        ...
        if not result.is_final:
            ...
            ex.c1PushText.setText(stri + transcript + overwrite_chars + '\r')
            ex.c1PushText.setFont(ex.myFontNormal)
            # ex.focused_box.setText(str(ex.focused_box.text) + transcript + overwrite_chars + '\r') 
        else:

            ex.c1PushText.setText(stri + transcript + overwrite_chars + '\r')
            ex.c1PushText.setFont(ex.myFont)
...
class App(QMainWindow):
    ...
    def initUI(self):
        ...
        self.c1FieldName3.setText('Customer ID')
        ...
        self.c1FieldName4.setText('Account No.')
        ...
        self.c1FieldName5.setText('Date')
